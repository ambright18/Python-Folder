#A python program that plays the 21 number game
...
#check whether the numbers are consectutive
def check(xyz):
    i = 1
    while i<len(xyz):
        if (xyz[i]-xyz[i-1]) != 1:
...
def start1():
    ...
    while True:
        ...
        print("Enter 'S' to take the seconds chance.")
        chance = input('> ')
            ...
            while last < 20:
                ...
                if xyz[-1] == 20:
                    ...
                    if check(xyz) == True:
                        ...
                        #if inputs are not consecutive, automatic disqualification
                        print("\nYou did not input consecutive integers.")
